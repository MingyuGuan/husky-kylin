...
std::string CubeDesc::getName() {
	return name;
}

void CubeDesc::setName(std::string name) {
	this->name = name;
}

std::string CubeDesc::getModelName() {
	return modelName;
}

void CubeDesc::setModelName(std::string modelName) {
	this->modelName = modelName;
}

DataModelDesc * CubeDesc::getModel() {
	return model;
}

void CubeDesc::setModel(DataModelDesc * model) {
	this->mdoel = model;
}
