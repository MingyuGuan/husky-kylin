...
const std::set<std::string> DataType::NUMBER_FAMILY {"tinyint", "smallint", "integer", "bigint", "int4", "long8", "float", "double", "decimal", "real", "numeric"};
...
bool DataType::isTinyInt() {
	return name.compare("tinyint") == 0;
}

bool DataType::isSmallInt() {
	return name.compare("smallint") == 0;
}

bool DataType::isInt() {
	return name.compare("int") == 0;
}

bool DataType::isBigInt() {
	return name.compare("bigint") == 0;
}

bool DataType::isFloat() {
	return name.compare("float") == 0;
}

bool DataType::isDouble() {
	return name.compare("double") == 0;
}

bool DataType::isDecimal() {
	return name.compare("decimal") == 0;
}

bool DataType::isBoolean() {
	return name.compare("boolean") == 0;
}
...
int DataType::getPrecision() {
	return precision;
}

int DataType::getScale() {
	return scale;
}
