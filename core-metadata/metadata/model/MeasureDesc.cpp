...
std::string MeasureDesc::getName() {
	return name;
}

void MeasureDesc::setName(std::string name) {
	this->name = name;
}

FunctionDesc * MeasureDesc::getFunction() {
	return function;
}

void MeasureDesc::setFunction(FunctionDesc * function) {
	this->function = function;
}